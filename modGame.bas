...
Public P(1 To 10) As Plane
Public Sh(1 To 10) As Ship
Public S(1 To 10) As Submarine
...
For I = 1 To 20
If E.CollisionDetect(Player.X, Player.Y, 50, 30, Player.Dir * 50, 0, frmGame.playm.hdc, PlShot(I).X, PlShot(I).Y, 5, 5, 0, 0, frmGame.bulletm.hdc) = True Then
Player.HP = Player.HP - 2
PlShot(I).Act = False
DoExplo PlShot(I).X - 2, PlShot(I).Y - 2, 3, 10, 10, 0, 0
End If

If E.CollisionDetect(Player.X, Player.Y, 50, 30, Player.Dir * 50, 0, frmGame.playm.hdc, ShShot(I).X, ShShot(I).Y, 5, 5, 0, 0, frmGame.bulletm.hdc) = True Then
Player.HP = Player.HP - 2
ShShot(I).Act = False
...
P(I2).Act = False
DoExplo P(I2).X, P(I2).Y - 20, 0, 50, 50, 0, 2
...
If B(I).ExploThing = False And B(I).Y > 203 Then DoExplo B(I).X - 5, B(I).Y - 20, 1, 20, 20, 0, 0: B(I).ExploThing = True: B(I).YS = 2
...
DoExplo Sh(I2).X, Sh(I2).Y, 4, 30, 50, 0, 1
End If
